...
class ProfileViewPreference(
    ...
    private var drawableResId = com.pvs.spent.R.drawable.ic_baseline_person_24
    ...
    override fun onBindViewHolder(holder: PreferenceViewHolder) {
        ...
        initImage = holder.findViewById(com.pvs.spent.R.id.initialTv) as TextView
        userImage = holder.findViewById(com.pvs.spent.R.id.userImage) as ImageView
        ...
        // Set name
        userName = holder.findViewById(com.pvs.spent.R.id.userName) as TextView
        userName.text = name

        // Set email
        userEmail = holder.findViewById(com.pvs.spent.R.id.userEmail) as TextView
