package com.param.expensesio.ui
...
class ProfileViewPreference(
    ...
    private var drawableResId = com.param.expensesio.R.drawable.ic_baseline_person_24
    ...
    override fun onBindViewHolder(holder: PreferenceViewHolder) {
        ...
        initImage = holder.findViewById(com.param.expensesio.R.id.initialTv) as TextView
        ...
        // Set name
        userName = holder.findViewById(com.param.expensesio.R.id.userName) as TextView
        userName.text = name

        // Set email
        userEmail = holder.findViewById(com.param.expensesio.R.id.userEmail) as TextView
